package br.com.caiqueborges.sprello.login;
...
public class LoginIT extends AbstractIT {
    ...
    private static final String JSON_SECURITY_FOLDER = JSON_FOLDER + LOGIN_FOLDER;
    private static final String SQL_SECURITY_FOLDER = SQL_FOLDER + LOGIN_FOLDER;

    public static final String CREATE_VALID_USER_SQL = SQL_SECURITY_FOLDER + "create-valid-user.sql";
    public static final String CREATE_VALID_USER_2_SQL = SQL_SECURITY_FOLDER + "create-valid-user-2.sql";
